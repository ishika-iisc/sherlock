...
OUTPUT = ROOT / "mtech_thesis_document_intelligence_research_centric.docx"
...
TITLE = "Evidence-Graded Agentic Retrieval-Augmented Generation for Trustworthy Document Intelligence over Visually Rich Business Documents"
AUTHOR = "Student Name"
SRNO = "SR Number"
...
def make_architecture_image(path: Path) -> None:
    ...
    draw.text((330, 40), "Evidence-Graded Document QA Research Framework", fill="#0B2545", font=font_title)
    box(520, 120, 560, 95, "Visually Rich Documents\nPDFs, scans, reports, contracts")
    box(520, 260, 560, 95, "Uncertainty-Aware Representation\nText, fields, confidence, logs")
    box(520, 400, 560, 95, "Question Planning\nIntent and field detection")
    box(130, 590, 330, 95, "Structured Lookup\nExact fields", "#FFFFFF")
    box(635, 590, 330, 95, "Semantic Retrieval\nCandidate evidence", "#FFFFFF")
    box(1120, 590, 330, 95, "Evidence Grading\nSufficiency check", "#FFFFFF")
    box(520, 760, 560, 95, "Grounded Answer\nEvidence, confidence, trace")
    box(1120, 760, 330, 95, "Human Review\nUncertain outputs", "#FFFFFF")
...
def process_block(doc: Document, block: str) -> None:
    ...
    if block.startswith("\\begin{table}"):
        ...
        if "Research metrics" in caption:
            doc.add_page_break()
...
def add_references(doc: Document) -> None:
    ...
    refs = [
        ...
        "Van Landeghem, J., Tito, R., Borchmann, L., Pietruszka, M., Joziak, P., Powalski, R., Jurkiewicz, D., Coustaty, M., Ackaert, B., Valveny, E., Blaschko, M., Moens, S., and Stanislaw, T. (2023). Document Understanding Dataset and Evaluation (DUDE). arXiv:2305.08455.",
        ...
        "Gao, T., Yen, H., Yu, J., and Chen, D. (2024). Groundedness in Retrieval-augmented Long-form Generation: An Empirical Study. arXiv:2404.07060.",
        "Niu, C., Wu, Y., Zhu, J., Xu, S., Shum, K., Zhong, R., Song, J., and Zhang, T. (2024). RAGTruth: A Hallucination Corpus for Developing Trustworthy Retrieval-Augmented Language Models. arXiv:2401.00396.",
